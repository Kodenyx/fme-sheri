...
const testimonials = [
  ...
  },
  {
    ...
    content: "I was genuinely impressed by how the tool delivered a well-crafted message, backed with clear scientific reasoning. It builds instant trust.",
...
const Testimonials = () => {
  return (
    <section className="pt-2 pb-16 bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50 relative overflow-hidden">
